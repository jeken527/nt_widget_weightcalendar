...
const Frame10544 = () => {
    ...
    const averageWeight = useMemo(() => {
        ...
        return (sum / weightsThisMonth.length).toFixed(1);
        ...
        for (let j = 0; j < 7; j++) {
            if (i === 0 && j < firstDayOfMonth) {
                ...
                week.push({ 
                    ...
                    dateKey: dateKey,
                    recordedWeight: weightRecords[dateKey]
                });
                dayCounter++;
            }
        }
                                                        ...
                                                        <div id="9_682" className="Pixso-frame-9_682">
                                                            <div id="9_677" className="Pixso-frame-9_677">
                                                                <div className="frame-content-9_677">
                                                                    <p id="9_678" className="Pixso-paragraph-9_678">{averageWeight}</p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div className="frame-content-7_663">
                                                ...
                                                <div onClick={handleInsertWeight} style={{cursor: 'pointer'}}>
                                                    <Insertbuttoncomponents
                                                        ...
                                                        mouseover={() => setSearch_button_state_7_660("checked")}
